...
import { CellAction } from '@/pages/agent/dashboard/article/components/students-table/cell-action';
import {
  ColumnDef,
  flexRender,
  getCoreRowModel,
...
import { getArticles } from '@/services/article/articleSlice';
...
export default function DataTable<TData, TValue>({
  ...
  // Utilisation du paramètre de recherche pour filtrer les articles
  ...
  }, [dispatch, searchParams]); // Inclure searchParams pour déclencher la récupération des articles lorsqu'ils changent
              ...
              filteredArticles.map((article) => (
                <TableRow key={article._id}>
                  <TableCell></TableCell>
                    ...
                    <TableCell><CellAction article={article} /></TableCell>
                </TableRow>
              ))
            ) : (
              <TableRow>
